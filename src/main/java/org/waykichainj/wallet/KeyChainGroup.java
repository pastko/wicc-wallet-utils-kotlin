...
import org.waykichainj.script.Script.ScriptType;
import org.waykichainj.script.ScriptBuilder;
...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.waykichainj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.waykichainj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.waykichainj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
