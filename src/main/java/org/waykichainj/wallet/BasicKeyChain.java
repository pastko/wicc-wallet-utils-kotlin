...
import org.waykichainj.core.BloomFilter;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.waykichainj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.waykichainj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
