...
import org.waykichainj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.waykichainj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.waykichainj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
